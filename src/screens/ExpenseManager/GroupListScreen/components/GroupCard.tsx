...
import {Box, Card, Icons, Text} from '../../../../components';
import {useNavigation} from '@react-navigation/native';
import {
  DrawerTabScreenProps,
  GroupsParamList,
    ...
    <TouchableOpacity
      ...
      <Card variant="elevated" bg="white" overflow="hidden">
        ...
        <Box
          ...
          bg="white"
          mt="-2">
          <Icons name={`${group.groupCategory}`} />
        </Box>
        ...
        <Box p="4">
          <Box flexDirection="row" justifyContent="space-between" pt="4">
            ...
            <Text
              ...
              fontWeight={900}>
              {group.split[0][user?.email!] < 0 ? 'You owe' : 'You are owed'}{' '}
              Rs.
              ...
              if (index < 2) {
                return (
                  <Box
                    ...
                    justifyContent="center"
                    alignItems="center"
                    marginRight={index == 1 || data.length == 1 ? '0' : '-2'}
                    height={60}
                    width={60}
                    bg="white"
                    borderColor="white"
